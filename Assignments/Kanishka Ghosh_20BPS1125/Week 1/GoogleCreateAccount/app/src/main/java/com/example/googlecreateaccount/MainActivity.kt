package com.example.googlecreateaccount
...
import com.example.googlecreateaccount.ui.theme.GoogleCreateAccountTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            GoogleCreateAccountTheme {
                Surface(
...
fun CreateAccount() {
    Column(
        ...
        modifier = Modifier.padding(start = 30.dp, end = 30.dp, bottom = 100.dp, top = 100.dp)
            .fillMaxHeight()
    ) {
        Image(
